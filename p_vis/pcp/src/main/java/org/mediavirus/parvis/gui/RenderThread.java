		...
		while (true) {
			...
			while (comp != null && progress) {
				...
				BufferedImage img = new BufferedImage(comp.getWidth(),
						comp.getHeight(), BufferedImage.TYPE_4BYTE_ABGR);
				...
				for (; i < comp.getNumRecords(); i++) {
					...
					if (brush != null) {
						bgcol = new Color(
								...
								(int) (0.1 * color.getGreen() + 0.9 * bgcol
										.getGreen()), (int) (0.1 * color
										.getBlue() + 0.9 * bgcol.getBlue()));
					}
					...
					if (i % 300 == 0) {
						comp.fireProgressEvent(new ProgressEvent(comp,
								ProgressEvent.PROGRESS_UPDATE, ((double) i)
					...
					if ((brush == null)
						...
						if ((brush != null) && quality) {
							Color col = new Color((int) (color.getRed()
									* brushVal + bgcol.getRed()
									* (1 - brushVal)), (int) (color.getGreen()
									* brushVal + bgcol.getGreen()
									* (1 - brushVal)), (int) (color.getBlue()
									* brushVal + bgcol.getBlue()
									* (1 - brushVal)), (int) (255 * brushVal));
							// System.out.println("Brush value: " + brushVal +
							// " alpha: " + col.getAlpha());
							g2.setColor(col);
						}
