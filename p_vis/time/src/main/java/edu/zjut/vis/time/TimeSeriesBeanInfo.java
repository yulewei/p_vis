...
public class TimeSeriesBeanInfo extends SimpleBeanInfo {
	public static String iconColor16file = "time16.png";
	public static String iconColor32file = "time32.png";
