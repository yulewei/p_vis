...
public class TreemapSummaryNode extends TreeMapNode{
	...
	public TreemapSummaryNode(String label, double order, Float sizeValue,Float colourValue,SummariseNode summaryNode) {
		super(label, order, sizeValue, colourValue);
		this.summaryNode=summaryNode;
	}
	
	public TreemapSummaryNode(String label, double order, Float sizeValue, Float colourValue, Point2D location,SummariseNode summaryNode) {
