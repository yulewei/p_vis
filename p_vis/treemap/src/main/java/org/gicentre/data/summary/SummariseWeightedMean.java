...
public class SummariseWeightedMean extends SummariseField{
	...
	public SummariseWeightedMean(String name,DataField dataField,DataField weightField){
		this(name,dataField,weightField,dataField.getFieldType());
	}

	public SummariseWeightedMean(String name,DataField dataField,DataField weightField,FieldType fieldType){
		this.name=name;
	...
	public Object compute(List<Record> records){
		if (dataField.getFieldType()==FieldType.STRING && weightField.getFieldType()==FieldType.STRING){
			return null;
		}
