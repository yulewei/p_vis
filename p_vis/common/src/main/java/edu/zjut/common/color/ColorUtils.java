...
public class ColorUtils {
	...
	public static ColourTable[] coloursCont;
	public static ColourTable[] coloursDiv;
	public static ColourTable[] coloursCat;
	public static ColourTable[][] catAll;
	...
	public static ColorSchemeType getColorSchemeType(ColourTable cTable) {
